...
const keyFeaturesList = [
    {
        id: '1',
        feature: "These are the key features about the product These stand as the key features about the product Here lie the key features about the product Behold the key features about the product reside here"
    },
    {
        id: '2',
        feature: "These are the key features about the product These stand as the key features about the product Here lie the key features about the product Behold the key features about the product reside here"
        ...
        return (
            <>
                ...
                <Text style={{ paddingTop: Sizes.fixPadding - 5.0, ...Fonts.blackColor16Medium, lineHeight: 20.0, }}>
                     These are the key features about the product. These stand as the key features about the product. Here lie the key features about the product. Behold the key features about the product reside here.
        ...
        return (
            <>
                ...
                <Text style={{ paddingVertical: Sizes.fixPadding, ...Fonts.primaryColor16Regular, lineHeight: 20.0, }}>
                    If the product's seal is tampered with, it cannot be returned.
                </Text>
            </>
        )
    }
